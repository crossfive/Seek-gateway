...
import com.crossfive.framework.clientTest.interfaces.IEvent;
  
public class RtspClientTest extends Thread implements IEvent {  
    ...
    public RtspClientTest(InetSocketAddress remoteAddress,  
    ...
    public static void main(String[] args) {  
        try {  
            ...
            // InetSocketAddress localAddress, String address)  
            RtspClientTest client = new RtspClientTest(  
                    new InetSocketAddress("218.204.223.237", 554),  
                    new InetSocketAddress("192.168.2.104", 0),  
